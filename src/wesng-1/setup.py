...
setup(
    name='wesng',
    version='1.0.2.1',
    description='WES-NG is een tool gebaseerd op de output van Windows\' systeminfo'
    ' command die een lijst opvangt met kwetsbaarheden van Windows opvangt'
    ', unclusief enige exploits voor deze kwetsbaarheden.',
